...
export default function HomeScreen() {
  ...
  const [nouvellePerceptionVisible, setNouvellePerceptionVisible] =
    useState(false);
    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <View className="flex flex-col flex-1 bg-[#f5f5f5]">
        ...
        <View className="absolute bottom-[30px] left-0 right-0 flex-row justify-between items-center px-8">
          ...
          <View className="flex-row gap-4 items-center bg-black p-3 rounded-full">
            <TouchableOpacity className="w-[45px] h-[45px] rounded-full bg-white justify-center items-center shadow-2xl">
        ...
        />
        <NouvellePerceptionSheet
          visible={nouvellePerceptionVisible}
          onClose={() => setNouvellePerceptionVisible(false)}
        />
        <ScannerRecuSheet
          visible={scannerRecuVisible}
          onClose={() => setScannerRecuVisible(false)}
        />
        <HistoriqueSheet
        ...
        />
        <SignalerFraudeSheet
          visible={signalerFraudeVisible}
          onClose={() => setSignalerFraudeVisible(false)}
        />
      </View>
    </TouchableWithoutFeedback>
  );
