...
import { Text, TextInput, TouchableOpacity, View, Alert, KeyboardAvoidingView, Platform, ScrollView, TouchableWithoutFeedback, Keyboard } from "react-native";
    ...
    >
      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        ...
        <View className="flex-1 px-5">
          <View className="flex-row gap-4 justify-center mb-8">
            {otp.map((digit, index) => (
              <TextInput
                ...
                className="w-[55px] h-[55px] bg-white border-[1px] border-[#e5e5e5] rounded-xl text-center text-2xl font-bold text-black"
          ...
          {/* Info */}
            <View className="bg-card-yellow border border-yellow-300 rounded-xl p-4 mt-6 flex-row gap-3">
